...
def colorLabels(classid):
    if classid == 0: #person
        color = (85, 45, 255)#purple
    elif classid == 2: #car
        color = (222, 82, 175)#pink
    elif classid == 3: #Motorbike
        color = (0, 204, 255)# light blue
    elif classid == 5: #Bus
        color = (0,149,255)#blue
    else:
...
def run(
    ...
    source = str(source)
    #ensure the output folder is created or not
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                #Extracts bounding boxes,class IDs,and confidences from model predictions.
                ...
                #DeepSORT Integeration for tracking and converts the bounding boxes to a compatible format
